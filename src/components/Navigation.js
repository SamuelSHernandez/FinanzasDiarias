                ...
                <nav className='navbar fixed-top navbar-expand-md bg-white'>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav nav d-flex flex-nowrap">
                            ...
                            <li className="nav-item active"><Link className="nav-link" to="/Articulos">Articulos</Link></li>
                            <li className="nav-item active"><Link className="nav-link" to="/Herramientas">Herramientas</Link></li>
