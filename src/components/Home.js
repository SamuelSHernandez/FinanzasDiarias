        ...
        <header>
            <div className="headerContainer">
                <div className="parallax-section">
                    ...
                    <div className="curso-propaganda">
    ...
    return (
        <div className='container mx-auto'>
            ...
            <div>
                ...
                <img className="promoImg  float-start img-fluid rounded m-3" alt="promoción" src={Promocion} />

                <div>

                    <p className="float-end text-justify promoText"> Estamos preparando un espacio de aprendizaje, el cual te dejará armas sólidas para poder emprender Si ya emprendiste algún negocio, te ayudaremos a que tengas claros cuales son tus retos financieros para que tomes mejores decisiones.
